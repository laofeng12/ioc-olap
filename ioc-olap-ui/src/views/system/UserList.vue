<template>
  <div class="app-container">
        ...
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="8">
            <el-form-item>
              ...
              <el-button type="primary" @click="resetSearchParams" icon="el-icon-refresh">重置</el-button>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="120">
        <template slot-scope="scope">
          ...
          <el-button size="small" class="ch-button-list-border-r" type="text" @click="userRole(scope.row.userid)">角色设置</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <UserRoleModal ref="userRoleModal"></UserRoleModal>
  </div>
</template>

<script>
import elementPagination from '@/components/ElementPagination'
import UserRoleModal from '@/components/system/user/UserRoleModal'
export default {
  components: {
    elementPagination,
    UserRoleModal
  ...
  methods: {
    ...
    userRole (userId) {
      this.$refs.userRoleModal.dialog(userId)
    }
  }
}
</script>
