  ...
  <div class="folderAside folderAside-draggable" v-loading="menuListLoading">
    ...
    <draggable class="draggable" :list="menuListTree" handle=".handle">
      ...
      <span class="custom-tree-node" slot-scope="{ node, data }" @mouseenter="enterNode">
        <div class="flex-box">
           <i class="el-icon-folder diy-icon handle" @click.stop v-show="node.level === 1"></i>
           <i class="el-icon-tickets diy-icon handle" @click.stop v-show="node.level === 2"></i>
