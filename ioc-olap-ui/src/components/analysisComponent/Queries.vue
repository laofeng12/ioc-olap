    ...
    <div class="content">
      <div class="editSql">
        ...
        <div class="bottom">
          ...
          <el-input-number  v-model="lineNumber" controls-position="right" :disabled="!checked" size="mini" style="margin-left: 8px;"></el-input-number>
          <el-button type="primary" size="mini" @click="searchOlap" :loading="loading" style="margin-left: 17px;">查询</el-button>
        </div>
      </div>
